...
export class TextAreaComponent extends BaseInput implements AfterViewChecked {
    ...
    /** @hidden */
    /** to track the current textarea content */
    ...
    autoGrowTextArea() {
        if (this.growing) {
            ...
            // console.log('maxheight' + this.textareaElement.nativeElement.style.maxHeight);
            // console.log('scroll' + this.textareaElement.nativeElement.scrollHeight);
            ...
            if (maxHeight) {
                // console.log('total height' + textareaTotalHeight);
    ...
    */
    ...
    handleBackPress(event: KeyboardEvent) {
        ...
        if (!this.showExceededText && KeyUtil.isKeyCode(event, [DELETE, BACKSPACE])) {
